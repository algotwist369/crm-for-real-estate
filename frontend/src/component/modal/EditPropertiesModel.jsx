...
import { FiX, FiHome, FiDollarSign, FiMapPin, FiInfo, FiLayers, FiUser, FiZap, FiTrendingUp } from "react-icons/fi";
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
            <div className="bg-zinc-950 border border-zinc-800 rounded-2xl w-full max-w-4xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300 flex flex-col max-h-[95vh]">
                ...
                <div className="flex items-center justify-between p-6 border-b border-zinc-800">
                    <div>
                        <h2 className="text-xl font-bold text-white">Edit Property Details</h2>
                        <p className="text-xs text-zinc-500 mt-1">Update information for ID: {property?.property_id}</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden">
                    <div className="p-6 space-y-8 overflow-y-auto custom-scrollbar">
                        ...
                        <div className="pb-4 border-b border-zinc-900">
                            <h3 className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-3">Listing Status</h3>
                            <PremiumTabs
