    ...
    useEffect(() => {
        if (lead && isOpen) {
            ...
            setFormData({
                ...
                budget: lead.budget || "",
                isCustomBudget: true, // Show all unknown string values as custom
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
            <div className="bg-zinc-950 border border-zinc-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300 flex flex-col max-h-[95vh]">
                ...
                <div className="flex items-center justify-between p-6 border-b border-zinc-800">
                    <div>
                        <h2 className="text-xl font-bold text-white">Edit Lead Profile</h2>
                        <p className="text-xs text-zinc-500 mt-1">Update client requirements and priorities</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden">
                    ...
                    <div className="p-6 border-t border-zinc-800 bg-zinc-950/50 flex gap-3">
                        ...
                        <div className="flex-1">
                            <PremiumButton
                                text={updateLeadMutation.isPending ? "Saving changes..." : "Save changes"}
                                type="submit"
